...
TORCH_LIBRARY_EXPAND(TORCH_EXTENSION_NAME, ops) {
    ops.def("varlen_fwd(Tensor! q, Tensor k, Tensor v, Tensor!? out, Tensor cu_seqlens_q, "
            ...
            "int num_splits, Generator? gen, Tensor? segment_num, Tensor? segment_lens, Tensor? segment_k_ptrs, Tensor? segment_v_ptrs, Tensor? segment_start_indices, bool force_split_kernel=False) -> Tensor[]");
